...
class uatg_csrbox_read_only_registers(IPlugin):
    ...
    def execute(self, core_yaml, isa_yaml):
        ...
        self.vendor_reg=self.hart['mvendorid']
        self.vendor_default=self.vendor_reg['reset-val']
        
        self.arch_reg=self.hart['marchid']
        self.arch_default=self.arch_reg['reset-val']
        
        self.imp_reg=self.hart['mimpid']
        self.imp_default=self.imp_reg['reset-val']
        
        self.hart_reg=self.hart['mhartid']
        self.hart_default=self.hart_reg['reset-val']
